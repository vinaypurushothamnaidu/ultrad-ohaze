...
O_haze_train_loader = DataLoader(dataset = RESIDE_Dataset(path + 'o-haze/O-HAZE/train', train = True), 
                             batch_size = BS, shuffle = True)

O_haze_test_loader = DataLoader(dataset = RESIDE_Dataset(path + 'o-haze/O-HAZE/val', train = False), 
                             batch_size = 1, shuffle = False)
